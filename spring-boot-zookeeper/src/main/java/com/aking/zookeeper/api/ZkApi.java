...
public class ZkApi {
     ...
     *
     * @param path
     * @param needWatch 指定是否复用 zookeeper中默认的 Watcher
     * @return
     */
    ...
    public boolean createNode(String path, String data) {
        try {
            ...
            e.printStackTrace();
            logger.error("【创建持久化节点异常】" + path + data);
            return false;
        }
    }
    ...
    public boolean updateNode(String path, String data) {
        try {
            ...
            e.printStackTrace();
            logger.error("【修改持久化节点异常】" + path + data);
            return false;
        }
    }
